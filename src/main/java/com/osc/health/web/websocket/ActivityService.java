package com.osc.health.web.websocket;

import com.osc.health.security.SecurityUtils;
import com.osc.health.web.websocket.dto.ActivityDTO;
...
import static com.osc.health.config.WebsocketConfiguration.IP_ADDRESS;
